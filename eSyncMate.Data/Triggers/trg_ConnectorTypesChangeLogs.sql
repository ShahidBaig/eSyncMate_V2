IF NOT EXISTS (SELECT * FROM sys.triggers WHERE name = 'trg_ConnectorTypesChangeLogs')
BEGIN
    EXEC('CREATE TRIGGER dbo.trg_ConnectorTypesChangeLogs
       ON dbo.ConnectorTypes
    ...
    BEGIN
        ...
        INSERT INTO dbo.ConnectorTypesLogs (ActionType, [Id], [Name], [Party], [CreatedDate], [CreatedBy])
        SELECT 
            @ActionType,
            COALESCE(i.Id, d.Id),
            COALESCE(i.Name, d.Name),
            COALESCE(i.Party, d.Party),

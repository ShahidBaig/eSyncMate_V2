...
@Component({
  selector: 'customers-help-dialog',
  templateUrl: './customers-help-dialog.component.html',
  styleUrls: ['./customers-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class CustomersHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<CustomersHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Customers — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Customers-Help-Guide.html';
    link.click();

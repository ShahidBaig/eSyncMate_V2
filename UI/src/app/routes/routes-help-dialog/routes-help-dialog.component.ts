...
@Component({
  selector: 'routes-help-dialog',
  templateUrl: './routes-help-dialog.component.html',
  styleUrls: ['./routes-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class RoutesHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<RoutesHelpDialogComponent>) {}
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Routes-Help-Guide.html';
    link.click();

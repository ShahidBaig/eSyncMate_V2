...
@Component({
  selector: 'product-catalog-help-dialog',
  templateUrl: './product-catalog-help-dialog.component.html',
  styleUrls: ['./product-catalog-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class ProductCatalogHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<ProductCatalogHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Product Catalog — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Product-Catalog-Help-Guide.html';
    link.click();

...
@Component({
  selector: 'inventory-help-dialog',
  templateUrl: './inventory-help-dialog.component.html',
  styleUrls: ['./inventory-help-dialog.component.scss'],
  standalone: true,
...
export class InventoryHelpDialogComponent {
  ...
  constructor(public dialogRef: MatDialogRef<InventoryHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Inventory Feed Summary — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Inventory-Feed-Summary-Help-Guide.html';
    link.click();

...
@Component({
  selector: 'users-help-dialog',
  templateUrl: './users-help-dialog.component.html',
  styleUrls: ['./users-help-dialog.component.scss'],
  standalone: true,
...
export class UsersHelpDialogComponent {
  ...
  constructor(public dialogRef: MatDialogRef<UsersHelpDialogComponent>) {}
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Users-Help-Guide.html';
    link.click();

...
@Component({
  selector: 'upload-prices-help-dialog',
  templateUrl: './upload-prices-help-dialog.component.html',
  styleUrls: ['./upload-prices-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class UploadPricesHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<UploadPricesHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Product Promotions — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Product-Promotions-Help-Guide.html';
    link.click();

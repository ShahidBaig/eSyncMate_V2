...
@Component({
  selector: 'connectors-help-dialog',
  templateUrl: './connectors-help-dialog.component.html',
  styleUrls: ['./connectors-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class ConnectorsHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<ConnectorsHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Connectors — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Connectors-Help-Guide.html';
    link.click();

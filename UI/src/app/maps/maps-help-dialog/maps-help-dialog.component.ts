...
@Component({
  selector: 'maps-help-dialog',
  templateUrl: './maps-help-dialog.component.html',
  styleUrls: ['./maps-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class MapsHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<MapsHelpDialogComponent>) {}
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Maps-Help-Guide.html';
    link.click();

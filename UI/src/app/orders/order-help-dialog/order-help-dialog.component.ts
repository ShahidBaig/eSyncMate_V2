...
export class OrderHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<OrderHelpDialogComponent>) {}
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Orders-Help-Guide.html';
    link.click();

...
@Component({
  selector: 'product-prices-help-dialog',
  templateUrl: './product-prices-help-dialog.component.html',
  styleUrls: ['./product-prices-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class ProductPricesHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<ProductPricesHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Product Prices — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Product-Prices-Help-Guide.html';
    link.click();

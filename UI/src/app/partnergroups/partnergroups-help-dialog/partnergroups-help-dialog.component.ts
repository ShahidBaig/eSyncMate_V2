...
@Component({
  selector: 'partnergroups-help-dialog',
  templateUrl: './partnergroups-help-dialog.component.html',
  styleUrls: ['./partnergroups-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class PartnerGroupsHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<PartnerGroupsHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Partner Groups — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Partner-Groups-Help-Guide.html';
    link.click();

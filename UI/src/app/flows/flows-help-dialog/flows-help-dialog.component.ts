...
@Component({
  selector: 'flows-help-dialog',
  templateUrl: './flows-help-dialog.component.html',
  styleUrls: ['./flows-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class FlowsHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<FlowsHelpDialogComponent>) {}
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Flows-Help-Guide.html';
    link.click();

...
@Component({
  selector: 'ship-nodes-help-dialog',
  templateUrl: './ship-nodes-help-dialog.component.html',
  styleUrls: ['./ship-nodes-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class ShipNodesHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<ShipNodesHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Ship Nodes — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Ship-Nodes-Help-Guide.html';
    link.click();

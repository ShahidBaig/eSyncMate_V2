...
@Component({
  selector: 'ship-codes-help-dialog',
  templateUrl: './ship-codes-help-dialog.component.html',
  styleUrls: ['./ship-codes-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class ShipCodesHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<ShipCodesHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>ShipCodes Mapping — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'ShipCodes-Mapping-Help-Guide.html';
    link.click();

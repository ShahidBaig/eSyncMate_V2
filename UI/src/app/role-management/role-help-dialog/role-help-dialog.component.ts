...
@Component({
  selector: 'role-help-dialog',
  templateUrl: './role-help-dialog.component.html',
  styleUrls: ['./role-help-dialog.component.scss'],
  standalone: true,
  imports: [MatDialogModule, MatIconModule, MatButtonModule, MatDividerModule, CommonModule, MatTooltipModule],
})
export class RoleHelpDialogComponent {
  @ViewChild('helpContent', { static: false }) helpContent!: ElementRef;
  constructor(public dialogRef: MatDialogRef<RoleHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Role Management — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Role-Management-Help-Guide.html';
    link.click();

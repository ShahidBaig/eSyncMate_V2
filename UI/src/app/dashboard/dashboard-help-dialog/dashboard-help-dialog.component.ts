...
@Component({
  selector: 'dashboard-help-dialog',
  templateUrl: './dashboard-help-dialog.component.html',
  styleUrls: ['./dashboard-help-dialog.component.scss'],
  standalone: true,
...
export class DashboardHelpDialogComponent {
  ...
  constructor(public dialogRef: MatDialogRef<DashboardHelpDialogComponent>) {}
...
<head>
  <meta charset="utf-8">
  <title>Dashboard — Help Guide</title>
...
<body>
  <div class="help-content">${content}</div>
    ...
    link.download = 'Dashboard-Help-Guide.html';
    link.click();

...
namespace eSyncMate.DB.Entities
{
    public class PartnerGroups : DBEntity, IDBEntity, IDisposable, IEqualityComparer
    {
        ...
        {
            totalCount = 0;
            string l_CountQuery = "SELECT COUNT(*) FROM [" + PartnerGroups.ViewName + "]";
            ...
            string l_Query = string.IsNullOrEmpty(p_Fields)
                ? "SELECT * FROM [" + PartnerGroups.ViewName + "]"
                : "SELECT " + p_Fields + " FROM [" + PartnerGroups.ViewName + "]";
        ...
        public Result Modify()
        {
            ...
            try
            {
                PartnerGroups.DBProperties = this.GetType().GetProperties()
               .Where(prop => prop.Name != "CreatedBy" && prop.Name != "CreatedDate")
               .ToList();

                PartnerGroups.EndingPropertyName = "ModifiedBy";

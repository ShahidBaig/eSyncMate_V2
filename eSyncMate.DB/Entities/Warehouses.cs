...
{
    public class Warehouses : DBEntity, IDBEntity, IDisposable, IEqualityComparer
    {
        ...
        /// TODO: Update summary.
        /// </summary>
        public Warehouses(DBConnector p_Connection) : base(p_Connection)
        {
            SetupDBEntity();
        }
        ...
        /// TODO: Update summary.
        /// </summary>
        public Warehouses(string p_ConnectionString) : base(p_ConnectionString)
        {
            SetupDBEntity();
        }
        ...
        private void SetupDBEntity()
        {
            ...
            if (string.IsNullOrEmpty(Warehouses.ViewName))
            {
                Warehouses.ViewName = "VW_Warehouses";
            }

            if (string.IsNullOrEmpty(Warehouses.PrimaryKeyName))
            {
                Warehouses.PrimaryKeyName = "Id";
            }

            if (string.IsNullOrEmpty(Warehouses.EndingPropertyName))
            {
                Warehouses.EndingPropertyName = "CreatedBy";
            }
            ...
            {
                Warehouses.InsertQueryStart = PrepareQueries(this, Warehouses.TableName, Warehouses.EndingPropertyName, ref l_Query, Warehouses.DBProperties);
            }
        }
        ...
        public bool GetList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            {
                l_Query = "SELECT * FROM [" + Warehouses.TableName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + Warehouses.TableName + "]";
            }
        ...
        public bool GetViewList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            if (string.IsNullOrEmpty(p_Fields))
            {
                l_Query = "SELECT * FROM [" + Warehouses.ViewName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + Warehouses.ViewName + "]";
            }
        ...
        {
            SetProperty(Warehouses.PrimaryKeyName, p_PrimaryKey);
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Warehouses.ViewName, Warehouses.PrimaryKeyName));
        }
        ...
        public int GetMax()
        {
            ...
            if (!l_Common.GetList("SELECT MAX(CONVERT(INT, ISNULL(" + Warehouses.PrimaryKeyName + ", '0'))) FROM " + Warehouses.TableName, ref l_Data))
            {
                return l_MaxNo;
            }
        ...
        {
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Warehouses.ViewName, Warehouses.PrimaryKeyName), true);
        }
        ...
        public Result GetObject(string propertyName, object propertyValue)
        {
            ...
            return GetObjectFromQuery(PrepareGetObjectQuery(this, Warehouses.ViewName, propertyName));
        }
        ...
        public Result SaveNew()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareInsertQuery(this, Warehouses.InsertQueryStart, Warehouses.EndingPropertyName, Warehouses.DBProperties);
        ...
        public Result Modify()
        {
            ...
            try
            {
                Warehouses.DBProperties = this.GetType().GetProperties()
                  .Where(prop => prop.Name != "CreatedBy" && prop.Name != "CreatedDate")
                  .ToList();

                Warehouses.EndingPropertyName = "ModifiedBy";

                l_Trans = this.Connection.BeginTransaction();

                l_Query = this.PrepareUpdateQuery(this, Warehouses.TableName, Warehouses.PrimaryKeyName, Warehouses.EndingPropertyName, Warehouses.DBProperties);
        ...
        public Result Delete()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareDeleteQuery(this, Warehouses.TableName, Warehouses.PrimaryKeyName);
        ...
        {
            return ((Warehouses)x).Id == ((Warehouses)y).Id;
        }

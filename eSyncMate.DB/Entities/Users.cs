...
namespace eSyncMate.DB.Entities
{
    public class Users : DBEntity, IDBEntity, IDisposable, IEqualityComparer
    {
        ...
        {
            totalCount = 0;
            string l_CountQuery = "SELECT COUNT(*) FROM [" + Users.ViewName + "]";
            ...
            string l_Query = string.IsNullOrEmpty(p_Fields)
                ? "SELECT * FROM [" + Users.ViewName + "]"
                : "SELECT " + p_Fields + " FROM [" + Users.ViewName + "]";
        ...
        public Result UpdatePassword(string userID, string password)
        {
            ...
            try
            {
                ...
                l_Query = $"UPDATE Users SET password = '{password}' WHERE UserID = '{userID}'";

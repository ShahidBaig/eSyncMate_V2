...
{
    public class EmailSendingData : DBEntity, IDBEntity, IDisposable, IEqualityComparer
    {
        ...
        /// TODO: Update summary.
        /// </summary>
        public EmailSendingData(DBConnector p_Connection) : base(p_Connection)
        {
            SetupDBEntity();
        }
        ...
        /// TODO: Update summary.
        /// </summary>
        public EmailSendingData(string p_ConnectionString) : base(p_ConnectionString)
        {
            SetupDBEntity();
        }
        ...
        private void SetupDBEntity()
        {
            ...
            if (string.IsNullOrEmpty(EmailSendingData.TableName))
            {
                EmailSendingData.TableName = "EmailSendingData";
            }

            if (string.IsNullOrEmpty(EmailSendingData.ViewName))
            {
                EmailSendingData.ViewName = "VW_EmailSendingData";
            }

            if (string.IsNullOrEmpty(EmailSendingData.PrimaryKeyName))
            {
                EmailSendingData.PrimaryKeyName = "Id";
            }

            if (string.IsNullOrEmpty(EmailSendingData.EndingPropertyName))
            {
                EmailSendingData.EndingPropertyName = "CreatedBy";
            }

            if (EmailSendingData.DBProperties == null)
            {
                EmailSendingData.DBProperties = new List<PropertyInfo>(this.GetType().GetProperties());
            }

            if (string.IsNullOrEmpty(EmailSendingData.InsertQueryStart))
            {
                EmailSendingData.InsertQueryStart = PrepareQueries(this, EmailSendingData.TableName, EmailSendingData.EndingPropertyName, ref l_Query, EmailSendingData.DBProperties);
            }
        }
        ...
        public bool GetList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            {
                l_Query = "SELECT * FROM [" + EmailSendingData.TableName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + EmailSendingData.TableName + "]";
            }
        ...
        public bool GetViewList(string p_Criteria, string p_Fields, ref DataTable p_Data, string p_OrderBy = "")
        {
            ...
            if (string.IsNullOrEmpty(p_Fields))
            {
                l_Query = "SELECT * FROM [" + EmailSendingData.ViewName + "]";
            }
            else
            {
                l_Query = "SELECT " + p_Fields + " FROM [" + EmailSendingData.ViewName + "]";
            }
        ...
        public bool GetEmailSendingDataData(ref DataTable p_Data)
        {
            string l_Query = string.Empty;

            l_Query = "SELECT ID,NAME FROM EmailSendingData WITH (NOLOCK)";
        ...
        {
            SetProperty(EmailSendingData.PrimaryKeyName, p_PrimaryKey);
            return GetObjectFromQuery(PrepareGetObjectQuery(this, EmailSendingData.ViewName, EmailSendingData.PrimaryKeyName));
        }
        ...
        public int GetMax()
        {
            ...
            if (!l_Common.GetList("SELECT MAX(CONVERT(INT, ISNULL(" + EmailSendingData.PrimaryKeyName + ", '0'))) FROM " + EmailSendingData.TableName, ref l_Data))
            {
                return l_MaxNo;
            }
        ...
        public Result GetObjectFromQuery(string p_Query, bool isOnlyObject = false)
        {
            ...
            PopulateObject(this, l_Data, DBProperties, EmailSendingData.EndingPropertyName);
        ...
        {
            SetProperty(EmailSendingData.PrimaryKeyName, p_PrimaryKey);
            return GetObjectFromQuery(PrepareGetObjectQuery(this, EmailSendingData.ViewName, EmailSendingData.PrimaryKeyName), true);
        }
        ...
        public Result GetObject(string propertyName, object propertyValue)
        {
            ...
            return GetObjectFromQuery(PrepareGetObjectQuery(this, EmailSendingData.ViewName, propertyName));
        }
        ...
        public Result SaveNew()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareInsertQuery(this, EmailSendingData.InsertQueryStart, EmailSendingData.EndingPropertyName, EmailSendingData.DBProperties);
        ...
        public Result Modify()
        {
            ...
            try
            {
                EmailSendingData.DBProperties = this.GetType().GetProperties()
                 .Where(prop => prop.Name != "CreatedBy" && prop.Name != "CreatedDate")
                 .ToList();

                EmailSendingData.EndingPropertyName = "ModifiedBy";

                l_Trans = this.Connection.BeginTransaction();

                l_Query = this.PrepareUpdateQuery(this, EmailSendingData.TableName, EmailSendingData.PrimaryKeyName, EmailSendingData.EndingPropertyName, EmailSendingData.DBProperties);
        ...
        public Result Delete()
        {
            ...
            try
            {
                ...
                l_Query = this.PrepareDeleteQuery(this, EmailSendingData.TableName, EmailSendingData.PrimaryKeyName);
        ...
        {
            return ((EmailSendingData)x).Id == ((EmailSendingData)y).Id;
        }

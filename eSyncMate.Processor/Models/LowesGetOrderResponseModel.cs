...
{
    public class LowesGetOrderResponseModel
    {
        public List<LowesOrder> orders { get; set; }
        public int total_count { get; set; }

        public LowesGetOrderResponseModel() 
        {
            this.orders = new List<LowesOrder>();
        }

        public class LowesOrder
        {

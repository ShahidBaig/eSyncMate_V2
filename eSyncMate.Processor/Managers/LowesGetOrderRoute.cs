    ...
    public class LowesGetOrderRoute
    {
        ...
        private static void ProcessOrder(LowesOrder order, Routes route, Customers customer, ConnectorDataModel sourceConnector, ConnectorDataModel destinationConnector, int userNo)
        {
            ...
            try
            {
                ...
                ackBody = JsonConvert.SerializeObject(l_LowesOrderAcceptInputModel);
                ...
                if (!string.IsNullOrEmpty(orderGetResponse))
                {
                    OrdersList = JsonConvert.DeserializeObject<LowesGetOrderResponseModel>(orderGetResponse);
                ...
                foreach (var orderLine in order.order_lines ?? new List<LowesGetOrderResponseModel.Order_Lines>())
                {
